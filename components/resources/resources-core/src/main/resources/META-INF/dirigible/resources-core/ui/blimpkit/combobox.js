 ...
 */
blimpkit.directive('bkComboboxInput', ['uuid', 'classNames', '$window', '$timeout', '$injector', function (uuid, classNames, $window, $timeout, $injector) {
    /**
     ...
     * isDisabled: Boolean - Whether the search input is disabled
     ...
     * btnAriaLabel: String - Aria-label for the combobox button
     * listAriaLabel: String - Aria-label for the combobox popover list
            ...
            <div class="fd-popover__control" ng-attr-disabled="{{isDisabled === true}}" ng-attr-aria-disabled="{{isDisabled === true}}" aria-expanded="{{ isBodyExpanded() }}" aria-haspopup="true" aria-controls="{{ bodyId }}">
                <bk-input-group compact="compact" class="fd-input-group--control" state="{{ state }}" is-disabled="isDisabled">
                    ...
                    <bk-input-group-addon>
                        <bk-button class="fd-select__button" glyph="sap-icon--navigation-down-arrow" type="transparent" state="{{ isBodyExpanded() ? 'expanded' : '' }}" ng-disabled="isDisabled" ng-click="onControllClick()" aria-label="{{btnAriaLabel}}" aria-controls="{{ bodyId }}" aria-haspopup="true"></bk-button>
                    </bk-input-group-addon>
                </bk-input-group>
            </div>

 ...
 */
angular.module('platformLayout', ['platformEditors', 'platformMessageHub', 'platformView'])
    ...
    .directive('layout', ['Views', 'Editors', 'SplitPaneState', 'messageHub', 'perspective', 'layoutConstants', 'branding', 'uuid', function (Views, Editors, SplitPaneState, messageHub, perspective, layoutConstants, branding, uuid) {
        return {
            ...
            templateUrl: '/services/web/resources-core/ui/templates/platform-layout.html'
        };
    }])
    ...
    .directive('accordionPane', ['$timeout', 'perspective', function ($timeout, perspective) {
        return {
            ...
            link: function (scope, _element, _attrs, accordionCtrl) {
    ...
    .directive('splittedTabs', ['messageHub', function (messageHub) {
        return {
            ...
            templateUrl: '/services/web/resources-core/ui/templates/splitted-tabs.html'
        };
    }]);
...
angular.module('platformShell', ['ngCookies', 'platformUser', 'platformBrand', 'platformExtensions', 'platformTheming', 'platformMessageHub'])
    ...
    }).directive('shellHeader', ['$cookies', '$http', 'branding', 'theming', 'User', 'Extensions', 'messageHub', function ($cookies, $http, branding, theming, User, Extensions, messageHub) {
        return {
            restrict: 'E',
            replace: true,
            scope: {
    ...
    }).directive('perspectiveContainer', function () {
        return {
            restrict: 'E',
            transclude: true,
            replace: true,
            template: `<div class="dg-main-container"></div>`
        }
    }).directive('shellDialogs', ['messageHub', 'Extensions', 'extensionPoints', function (messageHub, Extensions, extensionPoints) {
        return {
            restrict: 'E',
            replace: true,

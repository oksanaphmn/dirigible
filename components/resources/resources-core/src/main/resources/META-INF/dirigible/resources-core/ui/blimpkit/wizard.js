 ...
 */
blimpkit.directive('bkWizard', function () {
    /**
     * currentStep: Number - Wizard current step starting from 1
     * completedSteps: Number - The number of the completed steps
     * size: String - When specified adds horizontal paddings to the content. Could be one of: 'sm', 'md', 'lg', 'xl'
     */
    return {
        restrict: 'EA',
        replace: true,
...
})).directive('bkWizardContent', function (classNames) {
    /**
     * background: String - When specified applies specific background. Could be one of: 'solid', 'list', 'transparent'
     * size: String - When specified adds horizontal paddings to the content. Could be one of: 'sm', 'md', 'lg', 'xl'
     */
    return {
        restrict: 'EA',
...
}).directive('bkWizardStep', function (classNames) {
    /**
...
}).directive('bkWizardSummary', function (classNames) {
    /**
     * size: String - When specified adds horizontal paddings to the content. Could be one of: 'sm', 'md', 'lg', 'xl'
     */
    return {

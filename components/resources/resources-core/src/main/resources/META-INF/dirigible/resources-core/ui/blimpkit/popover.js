 ...
 */
blimpkit.directive('bkPopover', ['uuid', '$window', '$injector', 'backdrop', function (uuid, $window, $injector, backdrop) {
    /**
...
})).directive('bkPopoverBody', ['$window', '$timeout', 'ScreenEdgeMargin', 'classNames', function ($window, $timeout, ScreenEdgeMargin, classNames) {
    /**
     * align: String - Relative position of the popover. Possible values are:
    ...
    return {
        ...
        link: function (scope, element, _attrs, popoverCtrls) {
